...
FactPanel {
    ...
    Column {
       ...
       QGCButton {
        text: "Start Program"
        onClicked: controller.sendCommand(600, 0, 0, 100, 0, 0, 0, 0, 0, 0)
        }
       ...
       QGCButton {
        ...
        QGCButton {
        text: "Disable Safety "
        onClicked: controller.sendCommand(703, 0, 0, 1, 0, 0, 0, 0, 0, 0)
        }
