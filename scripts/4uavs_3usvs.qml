...
//    VF_USV_LINE_VERTICAL = 7,
        ...
        QGCButton {
            text: "USV_START "
            onClicked: controller.sendCommand(600, 0, 0, 13, 0, 0, 0, 0, 0, 0)
        }

        QGCButton {
            text: "USV_Stop "
            onClicked: controller.sendCommand(600, 0, 0, 14, 0, 0, 0, 0, 0, 0)
        }

        QGCButton {
            text: "USV LINE TRIANGLE"
            onClicked: controller.sendCommand(600, 0, 0, 5, 0, 0, 0, 0, 0, 0)
        }

        QGCButton {
            text: "USV LINE HORIZONTAL"
            onClicked: controller.sendCommand(600, 0, 0, 6, 0, 0, 0, 0, 0, 0)
        }

        QGCButton {
            text: "USV LINE VERTICAL"
