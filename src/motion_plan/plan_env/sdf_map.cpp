#include "motion_plan/plan_env/sdf_map.h"
...
void SDFMap::initMap(ros::NodeHandle& nh) {
    ...
    node_.param("sdf_map/map_size_x", x_size, 80.0);
    node_.param("sdf_map/map_size_y", y_size, 80.0);
    node_.param("sdf_map/map_size_z", z_size, 50.0);
    ...
    node_.param("sdf_map/local_update_range_z", mp_.local_update_range_(2), 4.5);
    node_.param("sdf_map/obstacles_inflation", mp_.obstacles_inflation_, 0.099);
    ...
    node_.param("sdf_map/depth_filter_tolerance", mp_.depth_filter_tolerance_, 0.15);
    node_.param("sdf_map/depth_filter_maxdist", mp_.depth_filter_maxdist_, 5.0);
    node_.param("sdf_map/depth_filter_mindist", mp_.depth_filter_mindist_, 0.2);
    node_.param("sdf_map/depth_filter_margin", mp_.depth_filter_margin_, 2);
    node_.param("sdf_map/k_depth_scaling_factor", mp_.k_depth_scaling_factor_, 1000.0);
    node_.param("sdf_map/skip_pixel", mp_.skip_pixel_, 2);

    node_.param("sdf_map/p_hit", mp_.p_hit_,  0.65);
    ...
    node_.param("sdf_map/max_ray_length", mp_.max_ray_length_, 4.5);

    node_.param("sdf_map/esdf_slice_height", mp_.esdf_slice_height_, 0.3);
    node_.param("sdf_map/visualization_truncate_height", mp_.visualization_truncate_height_, 2.49);
    node_.param("sdf_map/virtual_ceil_height", mp_.virtual_ceil_height_, 2.5);
    ...
    node_.param("sdf_map/ground_height", mp_.ground_height_, 0.0);
