        ...
        if (current_state.mode != "OFFBOARD" && !is_offboard_) {
            ...
            for (offboard_i = 10; ros::ok() && offboard_i > 0; --offboard_i) {
                if (set_mode_client.call(offb_set_mode) &&
                    ...
                    util_log("uav4s Offboard enabled");
                    is_offboard_ = true;
                }
            }
        }
...
void uav4_ros_Manager::wayPointCB(const mavros_msgs::WaypointList::ConstPtr &msg) {
    ...
    util_log("uav4 mission waypoint size = %d", uav_.waypointList.waypoints.size());
}
