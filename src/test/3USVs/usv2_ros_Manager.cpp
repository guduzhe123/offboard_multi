...
void usv2_ros_Manager::usv2OnInit(ros::NodeHandle &nh) {
...
void usv2_ros_Manager::drone_pos_update(const ros::TimerEvent& e) {
    DataMan::getInstance()->SetDroneData(usv2_);
}
...
void usv2_ros_Manager::usv2PosSp(const geometry_msgs::PoseStamped& way_point) {
