...
#ifndef OFFBOARD_WS_USV1_ROS_MANAGER_HPP
#define OFFBOARD_WS_USV1_ROS_MANAGER_HPP
...
public:
    ...
    void usv1OnInit(ros::NodeHandle &nh);
    void usv1PosSp(const geometry_msgs::PoseStamped& way_point);
...
#endif //OFFBOARD_WS_USV1_ROS_MANAGER_HPP
