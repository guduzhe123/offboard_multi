...
#ifndef OFFBOARD_WS_USV3_ROS_MANAGER_HPP
#define OFFBOARD_WS_USV3_ROS_MANAGER_HPP
...
public:
    ...
    void usv3OnInit(ros::NodeHandle &nh);
    void usv3PosSp(const geometry_msgs::PoseStamped& way_point);
...
#endif //OFFBOARD_WS_USV3_ROS_MANAGER_HPP
