...
#ifndef WINDAPPCORE_USV3_ACTIONMOTIONPLAN_HPP
#define WINDAPPCORE_USV3_ACTIONMOTIONPLAN_HPP

#include "IControlFunction.hpp"
#include "motion_plan/mp_core/MPManager.h"
#include "DataMan.hpp"

class USV3ActionMotionPlan : public IControlFunction {
public:
    /// @brief Constructor
    ///
    /// Constructor of the class USV3ActionMotionPlan.
    /// @param name the name of this class
    USV3ActionMotionPlan();

    /// @brief Destructor
    ///
    /// Destructor of the class ActionDroneMoving.
    ///
    ~USV3ActionMotionPlan() override = default;
...
public:
    ~USV3ActionMotionPlanFactory() {};

    IControlFunction* FunctionCreator()  {
        return USV3ActionMotionPlan::getInstance();
    }
};

#endif //WINDAPPCORE_USV3_ACTIONMOTIONPLAN_HPP
