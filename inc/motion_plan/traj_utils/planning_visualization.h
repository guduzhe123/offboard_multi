...
#include "motion_plan/path_searching/topo_prm.h"
...
private:
  ...
  ros::Publisher drone_sphere_pub_;       // 6, publish drone sphere
...
public:
  ...
  void drawDroneSpere(Eigen::Vector3d goal, double resolution, const Eigen::Vector4d& color, int id, int pub_id);
